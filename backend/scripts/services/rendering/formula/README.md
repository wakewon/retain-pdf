...
1. [`mode_router.py`](/workspace/example-project/backend/scripts/services/rendering/formula/mode_router.py)
2. [`core/markdown.py`](/workspace/example-project/backend/scripts/services/rendering/formula/core/markdown.py)
3. [`core/inline_math.py`](/workspace/example-project/backend/scripts/services/rendering/formula/core/inline_math.py)
4. [`fallback/placeholder_markdown.py`](/workspace/example-project/backend/scripts/services/rendering/formula/fallback/placeholder_markdown.py)
5. [`fallback/latex_normalizer.py`](/workspace/example-project/backend/scripts/services/rendering/formula/fallback/latex_normalizer.py)
6. [`fallback/png_renderer.py`](/workspace/example-project/backend/scripts/services/rendering/formula/fallback/png_renderer.py)
