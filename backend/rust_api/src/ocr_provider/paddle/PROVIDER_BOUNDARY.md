...
- API 摘要：
  [`API_SUMMARY.md`](/workspace/example-project/backend/rust_api/src/ocr_provider/paddle/API_SUMMARY.md)
- 官方异步接口示例：
...
根据 [AsyncParse.md](/workspace/example-project/backend/rust_api/src/ocr_provider/paddle/AsyncParse.md)，Paddle 的异步接口天然分成三段：
